...
--
-- Hôte : localhost:3306
-- Généré le : mer. 09 juin 2021 à 12:45
...
INSERT INTO `codes` (`id`, `user`, `code`, `status`) VALUES
(1, 'hello@gmaila.com', 'Beyourself_15', 0);
...
(1111115, 'hashir', 'hashir', 'Cameroun', '3', 'e10adc3949ba59abbe56e057f20f883e', 'hello@gmail.com'),
(1111117, 'hello@gmaila.com', 'hello@gmaila.com', 'Cameroun', '3', 'e158138f74899d782b7b2ba046fc7acc', 'hello@gmaila.com');
...
--
ALTER TABLE `students`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1111118;
COMMIT;
